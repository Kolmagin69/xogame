...
/*
 the tests are currently not working, to start them you need change the database.properties file
 in direction .\src\main\resources which will match the local login parameters postgres db
 */
